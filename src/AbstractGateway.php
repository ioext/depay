 ...
 *	throughout the DePay system.  It enforces implementation of
...
abstract class AbstractGateway implements GatewayInterface
{
	...
	{
		$obj = new $sFullClassName( $this->httpClient, $this->httpRequest );
		return $obj->initialize( array_replace( $this->getParameters(), $arrParameters ) );
	}

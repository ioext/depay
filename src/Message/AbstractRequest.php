...
namespace dekuan\depay\Message;


use GuzzleHttp\ClientInterface;

use dekuan\depay\Currency;
use dekuan\depay\Exception\InvalidRequestException;
use dekuan\depay\Exception\RuntimeException;
use dekuan\depay\Helper;
use dekuan\depay\ItemBag;
...
abstract class AbstractRequest implements RequestInterface
{
	...
	public function getAmount()
	{
		...
		if ( null !== $amount )
		{
			...
			{
				if ( is_int( $amount ) || 
					( is_string( $amount ) && false === strpos((string) $amount, '.') )
				)
				{
